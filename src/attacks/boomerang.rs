...
// ── Hybrid differential-linear and second-order analysis (from hybrid.rs) ─────
...
fn bit_parity_hybrid(x: u64) -> u64 {
...
fn lane_parity_4(
    ...
    bit_parity_hybrid(m1 & v1) ^ bit_parity_hybrid(m2 & v2) ^ bit_parity_hybrid(m3 & v3) ^ bit_parity_hybrid(m4 & v4)
}
